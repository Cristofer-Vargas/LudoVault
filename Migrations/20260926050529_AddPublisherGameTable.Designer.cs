...
namespace LudoVault.Migrations
{
    ...
    [Migration("20260926050529_AddPublisherGameTable")]
    partial class AddPublisherGameTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LudoVault.Model.DeveloperGameModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LudoVault.Model.DeveloperModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateOnly>("FundationAt")
                        .HasColumnType("DATE")
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            FundationAt = new DateOnly(2001, 12, 31),
                            Name = "Rockstar North"
                        },
                        new
                        {
                            Id = 2,
                            FundationAt = new DateOnly(1998, 12, 1),
                            Name = "Rockstar Games"
                        });
                });

            modelBuilder.Entity("LudoVault.Model.GameGenreModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LudoVault.Model.GameModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LauchedAt = new DateOnly(2018, 10, 26),
                            Name = "Red Dead Redemption 2"
                        });
                });

            modelBuilder.Entity("LudoVault.Model.GamePlatformModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LudoVault.Model.GenreModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LudoVault.Model.PlatformModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LudoVault.Model.PublisherGameModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LudoVault.Model.PublisherModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            FundationAt = new DateOnly(1889, 9, 1),
                            Name = "Nintendo"
                        },
                        new
                        {
                            Id = 3,
                            FundationAt = new DateOnly(1993, 11, 16),
                            Name = "Sony Interactive"
                        },
                        new
                        {
                            Id = 4,
                            FundationAt = new DateOnly(1992, 12, 31),
                            Name = "Take-Two Interactive"
                        });
                });

            modelBuilder.Entity("LudoVault.Model.RatingModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LudoVault.Model.UserLibraryModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LudoVault.Model.UserListItemModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LudoVault.Model.UserListModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LudoVault.Model.UserModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LudoVault.Model.DeveloperGameModel", b =>
                {
                    b.HasOne("LudoVault.Model.DeveloperModel", "Developer")
                    ...
                    b.HasOne("LudoVault.Model.GameModel", "Game")
            ...
            modelBuilder.Entity("LudoVault.Model.GameGenreModel", b =>
                {
                    ...
                    b.HasOne("LudoVault.Model.GenreModel", "Genre")
                        .WithMany("GameGenres")
            ...
            modelBuilder.Entity("LudoVault.Model.GamePlatformModel", b =>
                {
                    ...
                    b.HasOne("LudoVault.Model.PlatformModel", "Platform")
                        .WithMany("GamePlatforms")
            ...
            modelBuilder.Entity("LudoVault.Model.PublisherGameModel", b =>
                {
                    ...
                    b.HasOne("LudoVault.Model.PublisherModel", "Publisher")
                        .WithMany("PublisherGame")
            ...
            modelBuilder.Entity("LudoVault.Model.RatingModel", b =>
                {
                    ...
                    b.HasOne("LudoVault.Model.UserModel", "User")
                        .WithMany("Ratings")
            ...
            modelBuilder.Entity("LudoVault.Model.UserListItemModel", b =>
                {
                    ...
                    b.HasOne("LudoVault.Model.UserListModel", "UserList")
                        .WithMany("ListItems")
