...
namespace LudoVault.Api.Controllers
{
  ...
  public class UserController(IUserServices userServices) : ControllerBase
  {
    ...
    {
      return this.GetResponse(await _userServices.AtualizarUsuarioAsync(user, id));
    }

    [HttpPut("{id}/update-password")]
    public async Task<IActionResult> AtualizarSenhaUsuario([FromBody] UserPasswordUpdateRequest request, int id)
    {
      return this.GetResponse(await _userServices.AtualizarSenhaUsuarioAsync(request, id));
    }
    ...
    {
      return this.GetResponse(await _userServices.BuscarAvaliacoesAsync(id));
    }
    ...
    {
      return this.GetResponse(await _userServices.AdicionarAvaliacaoAsync(userRatingRequest, userId, gameId));
    }

    [HttpDelete("{userId}/rating/{ratingId}")]
    public async Task<IActionResult> RemoverUserRating(int userId, int ratingId)
    {
      return this.GetResponse(await _userServices.ExcluirAvaliacaoAsync(userId, ratingId));
    }
    ...
    {
      return this.GetResponse(await _userServices.AtualizarAvaliacaoAsync(userRatingRequest, userId, ratingId));
    }
    ...
    {
      return this.GetResponse(await _userServices.RemoverJogoDeListaAsync(userId, listId, gameId));
    }

    [HttpDelete("{userId}/list/{listId}")]
    public async Task<IActionResult> DeletarUserList(int userId, int listId)
    {
      return this.GetResponse(await _userServices.ExcluirListaAsync(userId, listId));
    }
    ...
    {
      return this.GetResponse(await _userServices.BuscarJogosDaBibliotecaAsync(userId));
    }

    [HttpPost("{userId}/library/game/{gameId}")]
    public async Task<IActionResult> AdicionarJogoABiblioteca(int userId, int gameId)
    {
      return this.GetResponse(await _userServices.AdicionarJogoABibliotecaAsync(userId, gameId));
    }

    [HttpDelete("{userId}/library/game/{gameId}")]
    public async Task<IActionResult> RemoverJogoDaBiblioteca(int userId, int gameId)
    {
      return this.GetResponse(await _userServices.RemoverJogoDaBibliotecaAsync(userId, gameId));
    }
  }
}
